...
path = os.path.join(MASS_BANK_DIR_PATH, f"compounds_safe_for_validation{FILE_FORMAT}")
...
path = os.path.join(MASS_BANK_DIR_PATH, f"compounds_unsafe_for_validation{FILE_FORMAT}")
...
path = os.path.join(MASS_BANK_DIR_PATH, f"compounds_safe_and_unsafe_for_validation{FILE_FORMAT}")
