...
MASSBANK_DIR_PATH = os.path.join(METADATA_SUBSET_DIR_PATH, 'validation', 'massbank')
VALIDATION_COVERAGE_DIR_PATH = os.path.join(MASSBANK_DIR_PATH, 'validation_coverage')
