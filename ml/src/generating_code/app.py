...
CONFIG = load_config(only_load=0)
...
def validation_set_coverage():
    ...
    with st.spinner(f"Loading.."):
        ...
        for subset_ids_list_name in subset_ids_list_names:
            ...
            df_presence_matrix = pd.read_parquet(path)
    ...
    # fig = px.imshow(presence_matrix, color_continuous_scale='Viridis', labels=dict(x="Compound Index", y="Sample Index"))
...
# Create navigation
nav_options = ["Massbank validation set coverage", "Assay endpoint coverage by compounds"]
